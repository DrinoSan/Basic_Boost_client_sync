...
#include "iobase/Utilities.h"
#include "entities/CommunicationConfig.h"
#include "components/CommInterfaceLogger.h"
#include "components/https/BeastUtils.h"
...
//--------------------------------------------------------------------------------------
// class to handle HTTPS - Requests as Client using boost::beast
//--------------------------------------------------------------------------------------
...
namespace one
{
    ...
    public:
        ...
        // Constructor
        // Fancy text
        Boost_basic_client( CommunicationConfig_t commConfig_, const std::string& defaultMimeType_ );
